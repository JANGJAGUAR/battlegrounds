...
public class PlayerCtrl : MonoBehaviour
{
    ...
    void UpdateLookRotation()
    {
        ...
        y *= invertY ? -1 : 1;
        targetRotation = transform.localRotation * Quaternion.AngleAxis(x * lookSpeed * Time.deltaTime, Vector3.up);
        targetPivotRotation = cameraPivot.localRotation * Quaternion.AngleAxis(y * lookSpeed * Time.deltaTime, Vector3.right);
